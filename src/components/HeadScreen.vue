...
<script setup>
import { systemOfParticles } from '@/use/useParticles';
...
.header__main-info{
    ...
    text-align: center;
    background-color: rgba(var(--first), 0.7);
    height: auto;
    max-width: 740px;
    margin: auto;
    padding: 40px 60px;
...
@media screen and ( max-width: 740px ){
    .header{
        background: url('@/assets/img/1.jpg') center no-repeat;
